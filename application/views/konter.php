                ...
                <div class="col-md-12">
                    <div class="box box-success">
                        <div class="box-body chart-responsive">
                          ...
                          <div id="chart_detail" style="margin:10px;">
    ...
    <script type="text/javascript">
      $(function(){
        ...
        $('#submit').click(function () {
            ...
            $.ajax({
            type : 'POST',
            url : "<?php echo site_url('Konter/ajax_chart');?>", //Here you will fetch records 
            ...
            success : function(data){
              ...
              // alert(data);
                ...
                var th= data.th;
                var tr= data.tr;
                // $('#chart_detail thead').remove();
                // $('#chart_detail tbody').remove();
                ...
                Highcharts.chart('chart_container', {
                    ...
                    $("#detail_tbl thead").html(th).delay(50);
                    $("#detail_tbl tbody").html(tr).delay(50);
                    /*$("#chart_detail thead").html(th);
                    $("#detail_tbl").delay(200);                    
                    $("#chart_detail tbody").html(tr);
                    $("#detail_tbl").delay(200);*/
                    ...
                    var table= $("#detail_tbl").DataTable({
                        /*dom: 'Blfrtip',
                        buttons: [
                            'copy', 'csv'
                        ]*/
